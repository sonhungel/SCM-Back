...
public class InventoryCheckServiceImpl implements InventoryCheckService {
    ...
    @Override
    public InventoryCheck createInventoryCheck(InventoryCheckDto inventoryCheckDto) throws ItemNumberNotFoundException {
    ...
    private InventoryCheck createNew(InventoryCheckDto inventoryCheckDto) throws ItemNumberNotFoundException {
